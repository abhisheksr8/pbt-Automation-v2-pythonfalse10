...
from automationpbt_v2pythonfalse10.graph import *
...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "pipelines/AutomationPBT_v2-pythonfalse10")
    spark.conf.set("spark.default.parallelism", "4")
    spark.conf.set("spark.sql.legacy.allowUntypedScalaUDF", "true")
    registerUDFs(spark)
    
    MetricsCollector.instrument(spark = spark, pipelineId = "pipelines/AutomationPBT_v2-pythonfalse10", config = Config)(
        pipeline
    )
